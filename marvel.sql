...
DELETE FROM movies;
-- deletes all lines from the table

DELETE FROM movies WHERE year = 2017;
-- deletes all matching that year

DELETE FROM movies WHERE title <> 'Black Panther';
-- deletes all that do not match

DELETE FROM movies WHERE id BETWEEN 1 AND 10;
-- deletes all within range

DELETE FROM movies WHERE title LIKE 'Iron Man%';
-- deletes all titles starting with 'Iron Man'
